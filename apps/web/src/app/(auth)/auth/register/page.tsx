        ...
        return (
            <div className="tw-w-full">
                <div className="tw-text-center">
                    <h1 className="tw-text-2xl tw-font-bold tw-tracking-tight">Account Created Successfully!</h1>
                    <p className="tw-mt-4 tw-text-gray-600">
                        We&apos;ve sent a verification link to <span className="tw-font-medium">{email}</span>.
                    ...
                    <div className="tw-mt-4 tw-flex tw-justify-center">
                        <svg className="tw-animate-spin tw-h-6 tw-w-6 tw-text-blue-600" viewBox="0 0 24 24">
                            <circle
    ...
    return (
        <div className="tw-w-full">
            <div className="tw-mb-8">
                <h1 className="tw-text-2xl tw-font-bold tw-tracking-tight">Create your account</h1>
                <p className="tw-mt-2 tw-text-sm tw-text-gray-600">
                    Already have an account?{" "}
                    <Link href="/auth/login" className="tw-font-medium tw-text-blue-600 hover:tw-text-blue-500">
                        Sign in
                    </Link>
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="tw-space-y-6">
                ...
                {error && (
                    <div className="tw-rounded-lg tw-bg-red-50 tw-p-4 tw-text-sm tw-text-red-600">
                        {error}
                    </div>
                )}
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="tw-w-full tw-rounded-lg tw-bg-blue-600 tw-px-4 tw-py-2 tw-text-sm tw-font-medium tw-text-white hover:tw-bg-blue-700 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-blue-500 focus:tw-ring-offset-2 disabled:tw-opacity-50 disabled:tw-cursor-not-allowed tw-flex tw-items-center tw-justify-center"
                >
                    {isLoading ? (
                        <>
                ...
                <div className="tw-relative">
                    ...
                    <div className="tw-relative tw-flex tw-justify-center tw-text-sm">
                        <span className="tw-bg-white tw-px-2 tw-text-gray-500">or continue with</span>
                    </div>
                </div>
                ...
                <div className="tw-grid tw-grid-cols-3 tw-gap-3">
                    <button
                        type="button"
                        disabled={isLoading}
                        className="tw-flex tw-w-full tw-items-center tw-justify-center tw-rounded-lg tw-border tw-border-gray-300 tw-bg-white tw-px-4 tw-py-2 tw-text-sm tw-font-medium tw-text-gray-700 hover:tw-bg-gray-50 disabled:tw-opacity-50 disabled:tw-cursor-not-allowed"
                    >
